...
"use strict";
    ...
    var CalendarControllerEdit = CalendarController.extend({
        //  _pushState: function () {
        // }
    });

    var CalendarViewEdit = CalendarView.extend({
        config: _.extend({}, CalendarView.prototype.config, {
            Controller: CalendarControllerEdit,
        }),
    ...
    var FormEditContent = baseEdit.ViewContent.extend({
        ...
        init: function(parent, params) {
            ...
            this.viewConfig.view = CalendarViewEdit;
        },
