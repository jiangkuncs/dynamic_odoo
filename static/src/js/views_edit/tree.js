    ...
    var ListProps = baseEdit.ViewProps.extend({
        init: function (parent, props) {
            ...
            this.nodeProps.sort_order = {
                name: 'sort_order', valType: "string", label: '排序顺序', widget: basic_fields.Selection,
                propChange: this.onChangeSort.bind(this),
                options: [{label: '升序', value: 'asc'}, {label: '降序', value: 'desc'}], classes: "tOrder"
            };
        ...
        initParams: function () {
            this._super();
            this.tabs.fields = {label: "字段", render: this.renderFieldsExist.bind(this), name: "fields"};
        },
