odoo.define('dynamic_odoo.ReportEdit', function (require) {
    ...
    var ReportView = base.WidgetBase.extend({
        ...
        onClickPrint: function () {
            return this.parent.props.action_manager._downloadReport(this._makeReportUrls(this.props.reportParams).pdf);
        },
        bindAction: function () {
    ...
    var ReportContent = baseEdit.ViewContent.extend({
        ...
        init: function (parent, params) {
            ...
            this.helperInfo = {
                ...
                column: {
                    ...
                    tag: "th, td",
                    selector: "table.o_main_table th, td",
                    add: this.addColumns,
                },
                hr: {
        ...
        prepareTemplate: function (templateId, jsonDoc) {
            const $view = this.ref.viewContent.$el;
        ...
        saveTemplate: function (reset = true) {
            ...
            return this['_rpc']({
                ...
                self.ref.viewView.renderElement();
            });
        },
        ...
        getDataValues: function (el) {
            if (!el || !el.length) {
                const {node} = this.state, viewContent = this.ref.viewContent;
        ...
        setVirtualHelper: function (type) {
            const helpInfo = this.helperInfo[type], viewEl = this.ref.viewView.$el.find(".wContent"),
        ...
        columnsHelper: function (helpInfo) {
            const viewEl = this.ref.viewView.$el.find(".wContent"), {selector, notSelect, class_name} = helpInfo;
        ...
        removeHelper: function () {
            ...
            const viewEl = this.ref.viewView.$el;
        ...
        inDOM: async function () {
            var {node} = this.state, $view = this.ref.viewView.$el;
            if (node) {
